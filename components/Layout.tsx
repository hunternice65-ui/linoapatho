    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <aside className="w-64 bg-slate-900 text-white flex flex-col hidden md:flex">
        ...
        <nav className="flex-1 px-4 space-y-1">
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition ${activeTab === 'setup' ? 'bg-slate-800 text-white' : 'text-slate-400 hover:bg-slate-800'}`}
          >
      ...
      <main className="flex-1 overflow-y-auto bg-slate-50 flex flex-col">
        ...
        <header className="md:hidden bg-white border-b p-4 flex justify-between items-center sticky top-0 z-50">
          ...
          <button className="p-2"><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16m-7 6h7"/></svg></button>
        </header>
